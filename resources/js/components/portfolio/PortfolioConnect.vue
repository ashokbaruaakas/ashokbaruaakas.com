    ...
    >
        <div class="flex flex-wrap gap-3">
            <a
                ...
                class="inline-flex items-center gap-2.5 rounded-full border border-border bg-card px-5 py-2.5 text-sm font-medium transition-all duration-300 hover:-translate-y-0.5 hover:border-emerald-600/50 hover:text-emerald-700 dark:hover:text-emerald-400"
            >
                <component
                    :is="Icon"
